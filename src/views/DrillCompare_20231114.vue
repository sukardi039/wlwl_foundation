  ...
  <v-container class="pa-3">
    <v-row>
      <v-col class="text-end">
        <v-btn outlined rounded height="25px" @click.stop="radioClicked()">
    ...
    <div id="hdr" class="comp">
      ...
      <div>
        ...
        <v-row>
          <v-col cols="3"></v-col>
          <v-col cols="1"><v-progress-linear color="blue darken-3" value="100" height="25"></v-progress-linear></v-col>
          <v-col cols="3">{{$t('DrillCompare.startName')}}</v-col>
          <v-col cols="1"><v-progress-linear color="orange" value="100" height="25"></v-progress-linear></v-col>
