      ...
      <v-col>
        ...
        >
          ...
          <v-col auto class="text-end mr-3">
            <span>{{ data.content.analysis.reportUser }}</span> <span v-if="!instructor" style="font-size: 0.7em;">({{w}}X{{h}})</span>
          </v-col>
        </v-row>
        <!-- Main bar -->
        <v-row dense class="align-center drill-header" style="height: 10vh;">
          ...
          <!-- Team status -->
          <v-col cols="5">
            <v-row dense class="align-center text-center" v-if="show || data.dayNumber > 1">
              <v-col>
                <DrillCircleProgress
