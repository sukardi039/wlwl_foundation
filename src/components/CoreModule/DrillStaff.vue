  ...
  <v-dialog persistent fullscreen v-model="paramdata">
    <v-row style="height: 90vh" align="center">
      ...
      <v-col cols="10">
        ...
        <v-card class="member-detail" color="#ffffff">
          <v-card-title :class="md" v-if="false"></v-card-title>
          <v-card-text class="member-background">
            <div v-if="data.action == 'INTRODUCTION' || showStaffOnly">
              <v-row style="height: 290px; align: center;">
                <v-col cols="3">
            ...
            >
              <v-row>
                <v-col cols="3">
                  <v-row dense style="height: 290px"
                    ><v-col>
                      <DrillStaffHead
                        :myStaff="myStaff"
                        :paramdata="paramdata"
                ...
                <v-col cols="9">
                  <div v-if="data.action == 'SELECT_STYLE'">
                    <v-row height="4px"><v-col></v-col></v-row>
                    <v-row dense class="member-detail member-selfintro pa-1" align="center" text-end>
                  ...
                  <div v-if="data.action == 'MORE_ACTIONS'">
                    <v-row height="0px"><v-col></v-col></v-row>
                    <v-row dense class="member-detail member-selfintro pa-1" align="center" text-end>
                      <v-col cols="9"
                        ><v-row v-if="actMsg">
                          <v-col cols="3"
                      ...
                      ><v-col cols="3" class="text-end">
                        <v-btn
                          ...
                          rounded
                          color="#434b5e"
                          v-if="(showSubAction) || !showSubAction || eTime == '0:00'"
            ...
            <div v-if="myStaff.staffName > 0">
              <v-row align="center" class="member-selfintro">
                <v-col cols="1" :class="md">
                  <v-img
                    v-if="em == '1-25'"
                ...
                <v-col cols="11"><span class="member-detail" style="font-size:1.45em;">{{
